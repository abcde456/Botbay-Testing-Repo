...
function fetchServer(requestType, data) {
...
function login(username, password) {
    //Attempt to login to an account, if account login success the user token will be returned.
}
...
class Team {
    constructor(teamName, members, owner) {
        //member and owner are "ids"
